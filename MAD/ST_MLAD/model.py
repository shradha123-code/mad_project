...
class MLAD_Model(nn.Module):
    def __init__(self, n_features, batch_size):
        super(MLAD_Model, self).__init__()
    ...
    def forward(self, inputs, meta_loss=None, meta_step_size=None, stop_gradient=False):
        ...
        scores = self.relu(linear(inputs=features,
        ...
        scores = self.relu(linear(inputs=scores,
        ...
        scores = self.sigmoid(linear(inputs=scores,
