...
parser.add_argument('--lr', type=str, default='[0.01]*20000', help='learning rates for steps(list form)')
...
parser.add_argument('--trainPickleFile', type=str, default='final_100iter.pkl', help='temp dir')
parser.add_argument('--numIterations', type=int, default=100, help='number of interations')
parser.add_argument('--metaStepSize', type=float, default=0.001, help='stepsize')
parser.add_argument('--metaValBeta', type=float, default=0.1, help='valbeta')
parser.add_argument('--norlabelFile', type=str, default='nor_path_label.txt', help='norlabel')
parser.add_argument('--abnorlabelFile', type=str, default='abnor_path_label.txt', help='abnorlabel')