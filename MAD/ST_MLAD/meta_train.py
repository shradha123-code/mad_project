...
def meta_train(nloader, aloader, model, batch_size, optimizer, viz, device, meta_loss=None, meta_step_size=None, stop_gradient=False):
    with torch.set_grad_enabled(True):
        ...
        feat_normal_bottom, scores, scores_nor_bottom, scores_nor_abn_bag, _ = model(input, meta_loss,
                                          meta_step_size,
                                          stop_gradient)  # b*32  x 2048
